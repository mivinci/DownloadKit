...
- [Modules](modules/README.md)
  - [xbase — Core Primitives](modules/xbase/README.md)
    ...
    - [Dynamic String](modules/xbase/string.md)
  ...
  - [xjs — JavaScript Engine](modules/xjs/README.md)
    ...
    - [Classes & Native Wrappers](modules/xjs/class.md)
    - [Strings](modules/xjs/string.md)
    - [Script Evaluation](modules/xjs/eval.md)
    - [ES Modules](modules/xjs/module.md)
