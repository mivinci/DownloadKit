 ...
 * moo applications.  It is currently implemented on top of QuickJS,
 ...
 * a handful of moo-specific extensions documented below.
 *
 ...
 *
 * These mirror the JSC types one-to-one.  We do NOT use moo's
