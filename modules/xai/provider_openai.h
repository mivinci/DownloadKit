 ...
 *
 * Implements the xAiProvider contract for any endpoint that speaks
...
#ifndef XAI_PROVIDER_OPENAI_H
#define XAI_PROVIDER_OPENAI_H
 ...
 */
XCAPI(xAiProvider) xAiProviderOpenAICreate(xEventLoop           loop,
                                           xHttpClient          http,
                                           const xAiOpenAIConf *conf);

#endif /* XAI_PROVIDER_OPENAI_H */
