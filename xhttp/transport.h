 ...
 *
 * transport.h - Transport abstraction layer for HTTP connections
 *
...
#ifndef XHTTP_TRANSPORT_H
#define XHTTP_TRANSPORT_H
 ...
 */
XDEF_ENUM(xHttpTransportResult){
  xHttpTransportResult_Done      = 0, /**< Handshake complete              */
  xHttpTransportResult_WantRead  = 1, /**< Need more data (register read)  */
  xHttpTransportResult_WantWrite = 2, /**< Need to write (register write)  */
  xHttpTransportResult_Error     = -1 /**< Handshake failed                */
};
...
XDEF_STRUCT(xHttpTransport) {
   ...
   * Returns xHttpTransportResult_Done, WantRead, WantWrite, or Error.
